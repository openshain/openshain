...
const allowed: Record<WorkStatus, readonly WorkStatus[]> = {
  ...
  waiting_input: ["in_progress", "paused", "cancelled", "failed"],
  waiting_approval: ["in_progress", "paused", "cancelled", "failed"],
  waiting_external: ["in_progress", "paused", "cancelled", "failed"],
  // A stopped work goes back to whatever it was doing. Giving it up is still open to the person.
  paused: [
    "in_progress",
    "waiting_input",
    "waiting_approval",
