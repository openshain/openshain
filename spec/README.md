...
| [authority.md](authority.md) | draft v0.1 | 権限と承認です。Principal と Delegation、`authority/` の判定の表、承認と Review の流れ、Decision の記録を決めます。未実装です |
| [authority.plan.md](authority.plan.md) | draft | 上の spec の実装計画です。5 タスク |
